...
class AppColors {
  ...
  static const Color darkPrimary = Color(
    0xFF8B5CF6,
  ); // Pleasing Violet 500 accent
  static const Color darkPrimaryLight = Color(0xFFA78BFA); // Violet 400
  static const Color darkNavSelectedBg = Color(
    0xFF2D2445,
  ); // Subtle violet tint for pill bg
  ...
  static const Color darkPrimaryContainer = Color(
    0xFF262626,
  ); // Slightly lighter than surface for text fields
}
