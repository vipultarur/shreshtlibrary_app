...
class LeaderboardScreen extends ConsumerWidget {
                                    ...
                                    children: [
                                      Stack(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: (entry.student.profilePhoto != null && entry.student.profilePhoto!.isNotEmpty)
                                                ? CachedNetworkImage(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Icon(Icons.military_tech, size: 14, color: badgeColor),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            entry.hoursFormatted.contains(' ') ? entry.hoursFormatted.split(' ')[1] : 'hrs',
                                            style: TextStyle(
  ...
  Widget _buildPodium(List<LeaderboardEntry> top3, ThemeData theme) {
    ...
    final sorted = List<LeaderboardEntry>.from(top3)..sort((a, b) => a.rank.compareTo(b.rank));
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          if (rank2 != null) Expanded(child: _buildPodiumItem(rank2, 2, 120, theme)),
          if (rank1 != null) Expanded(child: _buildPodiumItem(rank1, 1, 160, theme)),
          if (rank3 != null) Expanded(child: _buildPodiumItem(rank3, 3, 100, theme)),
        ],
      ),
    );
  }

  Widget _buildPodiumItem(LeaderboardEntry entry, int rank, double podiumHeight, ThemeData theme) {
    Color rankColor;
      ...
      children: [
        ...
        Container(
          ...
          child: (entry.student.profilePhoto != null && entry.student.profilePhoto!.isNotEmpty)
              ...
              : Icon(Icons.person, color: theme.colorScheme.primary, size: isFirst ? 40 : 32),
        ),
        const SizedBox(height: 8),
        Text(
          entry.student.fullName.split(' ').first,
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: isFirst ? 16 : 14, color: theme.textTheme.bodyLarge?.color),
          maxLines: 1,
          overflow: TextOverflow.ellipsis,
        ),
        ...
        Container(
          ...
          height: podiumHeight,
          decoration: BoxDecoration(
            color: theme.colorScheme.primary.withValues(alpha: isFirst ? 0.8 : (rank == 2 ? 0.6 : 0.4)),
