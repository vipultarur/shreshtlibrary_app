        ...
        children: [
          SectionCard(
              ...
              child: AsyncPane(
                ...
                builder: (profile) => _ProfileEditor(profile: profile),
              ),
            ),
...
class _ReferralApplyForm extends ConsumerStatefulWidget {
  const _ReferralApplyForm();

  @override
  ConsumerState<_ReferralApplyForm> createState() => _ReferralApplyFormState();
}

class _ReferralApplyFormState extends ConsumerState<_ReferralApplyForm> {
